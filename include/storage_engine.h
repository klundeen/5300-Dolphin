...
class ColumnAttribute {
  public:
    enum DataType { INT, TEXT, BOOLEAN };
...
class DbRelation {
  public:
     ...
     * @returns column_attributes dictionary of column attributes keyed by
     * column names
     */
...
class DbIndex {
  public:
    ...
    // ctor/dtor
    DbIndex(DbRelation &relation, Identifier name, ColumnNames key_columns,
            bool unique)
        : relation(relation), name(name), key_columns(key_columns),
          unique(unique) {}
